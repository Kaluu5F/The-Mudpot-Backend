...
import com.the.mudpot.security.JwtAuthenticationFilter;
import com.the.mudpot.security.JwtTokenProvider;
import com.the.mudpot.dto.UserDTO;
import com.the.mudpot.model.CustomUserDetails;
import com.the.mudpot.model.Role;
import com.the.mudpot.model.User;
import com.the.mudpot.util.AppConfig;
...
import com.the.mudpot.util.RoleList;
...
public class UserService implements UserDetailsService {
    ...
    public void createSuperAdmin() {
        if (userRepository.findByUserName(Messages.ADMIN_ROLE).isEmpty()) {
            ...
            if (adminRole == null) {
                adminRole = new Role();
                adminRole.setRole(String.valueOf(RoleList.admin));
    ...
    public UserDTO patchUser(String userId, UserDTO updatedUser) {
        ...
        User permisionUser = userRepository.findById(userID)
                .orElseThrow(() -> new CustomException(HttpStatus.NOT_FOUND.value(), Messages.USER_NOT_FOUND, Messages.NOT_FOUND));
        if (permisionUser.getRole().getRole().equals(String.valueOf(RoleList.user))) {
        ...
        if (permisionUser.getRole().getRole().equals(String.valueOf(RoleList.admin))) {
